...
const Stat = (props) => {
    ...
    const calculateCropCarbon = (name, yieldValue, areaValue) => {
        ...
        if (name === 'ozimaya_rozh') {
            if (Y >= 10 && Y <= 26) {
                return (((0.3 * Y + 3.2) * 45 / 100) + ((0.6 * Y + 8.9) * 45 / 100)) * S;
            } else if (Y > 26) {
                return (((0.2 * Y + 6.3) * 45 / 100) + ((0.6 * Y + 13.9) * 45 / 100)) * S;
            } else {
                return 'Проверьте введенную урожайность'; // Сообщение, если урожайность не попадает в параметры
            }
        } else if (name === 'ozimaya_pshenica') {
            if (Y >= 10 && Y <= 26) {
                return (((0.4 * Y + 2.6) * 48.53 / 100) + ((0.9 * Y + 5.8) * 48.53 / 100)) * S;
            } else if (Y > 26) {
                return (((0.1 * Y + 8.9) * 48.53 / 100) + ((0.7 * Y + 10) * 48.53 / 100)) * S;
            }
        } else if (name === 'yarovaya_pshenica') {
            if (Y >= 10 && Y <= 20) {
                return (((0.4 * Y + 1.8) * 48.53 / 100) + ((0.7 * Y + 10.2) * 48.53 / 100)) * S;
            } else if (Y > 20) {
                return (((0.2 * Y + 5.4) * 48.53 / 100) + ((0.8 * Y + 6) * 48.53 / 100)) * S;
            }
        } else if (name === 'yachmen') {
            if (Y >= 10 && Y <= 20) {
                return (((0.4 * Y + 1.8) * 45.67 / 100) + ((0.8 * Y + 6.5) * 45.67 / 100)) * S;
            } else if (Y > 20) {
                return (((0.09 * Y + 7.6) * 45.67 / 100) + ((0.4 * Y + 13.45) * 45.67 / 100)) * S;
            }
        } else if (name === 'oves') {
            if (Y >= 10 && Y <= 20) {
                return (((0.3 * Y + 3.2) * 45 / 100) + ((1 * Y + 2) * 45 / 100)) * S;
            } else if (Y > 20) {
                return (((0.15 * Y + 6.12) * 45 / 100) + ((0.4 * Y + 16) * 45 / 100)) * S;
            }
        } else if (name === 'proso') {
            if (Y >= 5 && Y <= 20) {
                return (((0.2 * Y + 5) * 46.87 / 100) + ((0.8 * Y + 7) * 46.87 / 100)) * S;
            } else if (Y > 20) {
                return (((0.3 * Y + 3.3) * 46.87 / 100) + ((0.56 * Y + 11.2) * 46.87 / 100)) * S;
            }
        } else if (name === 'kukuruzaNaZerno') {
            if (Y >= 10) {
                return (((0.23 * Y + 3.5) * 45 / 100) + ((0.8 * Y + 5.8) * 45 / 100)) * S;
            }
        } else if (name === 'goroh') {
            if (Y >= 5 && Y <= 20) {
                return (((0.14 * Y + 3.5) * 45 / 100) + ((0.66 * Y + 7.5) * 45 / 100)) * S;
            } else if (Y > 20) {
                return (((0.2 * Y + 1.7) * 45 / 100) + ((0.37 * Y + 12.9) * 45 / 100)) * S;
            }
        } else if (name === 'grechixa') {
            if (Y >= 5 && Y <= 15) {
                return (((0.25 * Y + 4.3) * 45 / 100) + ((1.1 * Y + 5.3) * 45 / 100)) * S;
            } else if (Y > 15) {
                return (((0.2 * Y + 5.2) * 45 / 100) + ((0.54 * Y + 14.1) * 45 / 100)) * S;
            }
        } else if (name === 'podsolnechnik') {
            if (Y >= 8) {
                return (((0.4 * Y + 3.1) * 45 / 100) + ((1 * Y + 6.6) * 45 / 100)) * S;
            }
        } else if (name === 'kartofel') {
            if (Y >= 50 && Y <= 200) {
                return (((0.04 * Y + 1) * 42.26 / 100) + ((0.08 * Y + 4) * 42.26 / 100)) * S;
            } else if (Y > 200) {
                return (((0.03 * Y + 4.1) * 42.26 / 100) + ((0.06 * Y + 8.6) * 42.26 / 100)) * S;
            }
        } else if (name === 'saharnayaSvecla') {
            if (Y >= 100 && Y <= 200) {
                return (((0.003 * Y + 2.5) * 40.72 / 100) + ((0.06 * Y + 5.45) * 40.72 / 100)) * S;
            } else if (Y > 200) {
                return (((0.02 * Y + 0.8) * 40.72 / 100) + ((0.07 * Y + 3.5) * 40.72 / 100)) * S;
            }
        } else if (name === 'ovoshi') {
            if (Y >= 50 && Y <= 200) {
                return (((0.02 * Y + 1.5) * 45 / 100) + ((0.06 * Y + 5) * 45 / 100)) * S;
            } else if (Y > 200) {
                return (((0.006 * Y + 3.6) * 45 / 100) + ((0.04 * Y + 6) * 45 / 100)) * S;
            }
        } else if (name === 'kormovyeKorneplody') {
            if (Y >= 50 && Y <= 200) {
                return (((0.003 * Y + 2.4) * 40.72 / 100) + ((0.05 * Y + 5.2) * 40.72 / 100)) * S;
            } else if (Y > 200) {
                return (((0.01 * Y + 1) * 40.72 / 100) + ((0.05 * Y + 5.5) * 40.72 / 100)) * S;
            }
        } else if (name === 'len') {
            if (Y >= 3) {
                return (((1.3 * Y + 9.4) * 45 / 100)) * S;
            }
        } else if (name === 'konoplya') {
            if (Y >= 3) {
                return (((2.2 * Y + 9.1) * 45 / 100)) * S;
            }
        } else if (name === 'silosnye') {
            if (Y >= 100 && Y <= 200) {
                return (((0.03 * Y + 3.6) * 45 / 100) + ((0.12 * Y + 8.7) * 45 / 100)) * S;
            } else if (Y > 200) {
                return (((0.03 * Y + 4.1) * 42.26 / 100) + ((0.06 * Y + 8.6) * 42.26 / 100)) * S;
            }
            ...
            if (Y >= 100 && Y <= 200) {
                ...
                return (((0.02 * Y + 5) * 45 / 100) + ((0.08 * Y + 16.2) * 45 / 100)) * S;
            }
        } else if (name === 'odnoletnieTravy') {
            if (Y >= 10) {
                return (((0.13 * Y + 6) * 45 / 100) + ((0.7 * Y + 7.5) * 45 / 100)) * S;
            }
        } else if (name === 'mnogoletnieTravy') {
            if (Y >= 10 && Y <= 35) {
                return (((0.2 * Y + 6) * 45 / 100) + ((0.8 * Y + 11) * 45 / 100)) * S;
            } else if (Y > 35) {
                return (((0.1 * Y + 10) * 45 / 100) + ((1 * Y + 15) * 45 / 100)) * S;
            }
        }
