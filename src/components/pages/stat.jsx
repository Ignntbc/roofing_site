            ...
            <FormContainer style={{ alignItems: 'flex-start' }}>
                ...
                <FormControl style={{ marginTop: '10px', marginBottom: '12px' }}>
                    ...
                    >
                        ...
                        <FormControlLabel value="5" control={<Radio />} label="Механические потери почвенного углерода в результате эрозии и дефляции" />
                    ...
                    <FormGroup>
                        ...
                        <div style={{ alignItems: 'center' }}>
                            <FormControlLabel
                                ...
                                label="Торф"
                            />
                            {checkboxStates.torf && <InputComponent inputValue={torfValue} action={setTorfValue} placeholder={"Введите внесенное количество торфа за год в тоннах"} />}
                        </div>
                        <div style={{ alignItems: 'center' }}>
                            <FormControlLabel
                                ...
                                label="Помет"
                            />
                            {checkboxStates.pom && <InputComponent inputValue={pomValue} action={setPomValue} placeholder={"Введите внесенное количество помета за год в тоннах"} />}
                        </div>
                        <div style={{ alignItems: 'center' }}>
                            <FormControlLabel
                        ...
                        <FormGroup>
                            ...
                            <div style={{ alignItems: 'center' }}>
                                <FormControlLabel
                                    ...
                                    label="Азотные"
                                />
                                {checkboxStates2.azot && <InputComponent inputValue={azotValue} action={setAzotValue} placeholder={"Введите внесенное количество азотных удобрений за год в тоннах"} />}
                            </div>
                            <div style={{ alignItems: 'center' }}>
                                <FormControlLabel
                                    ...
                                    label="Фосфорные"
                                />
                                {checkboxStates2.fosfor && <InputComponent inputValue={fosforValue} action={setFosforValue} placeholder={"Введите внесенное количество фосфорных удобрений за год в тоннах"} />}
                            </div>
                            <div style={{ alignItems: 'center' }}>
                                <FormControlLabel
                                    ...
                                    label="Калийные"
                                />
                                {checkboxStates2.kaliy && <InputComponent inputValue={kaliyValue} action={setKaliyValue} placeholder={"Введите внесенное количество калийных удобрений за год в тоннах"} />}
                            </div>
                                ...
                                <div style={{ alignItems: 'center' }}>
                                    ...
                                    {checkboxStates.navoz1 && (
                                        <InputComponent
                                            ...
                                            placeholder="Введите внесенное количество навоза подстилочного за год в тоннах"
                                        />
                                    )}
                                </div>
                                <div style={{ alignItems: 'center' }}>
                                    ...
                                    {checkboxStates.navoz2 && (
                                        <InputComponent
                                            ...
                                            placeholder="Введите внесенное количество навоза бесподстилочного за год в тоннах"
                                        />
                                    )}
                                </div>
                                <div style={{ alignItems: 'center' }}>
                                    ...
                                    {checkboxStates.torf && (
                                        <InputComponent
                                            ...
                                            action={setTorfValue}
                                            placeholder="Введите внесенное количество торфа за год в тоннах"
                                        />
                                    )}
                                </div>
                                <div style={{ alignItems: 'center' }}>
                                    ...
                                    {checkboxStates.pom && (
                                        <InputComponent
                                            inputValue={pomValue}
                                            action={setPomValue}
                                            placeholder="Введите внесенное количество помета за год в тоннах"
                                        />
                                    )}
                                </div>
                                <div style={{ alignItems: 'center' }}>
                                    ...
                                    {checkboxStates.other && (
                                        <InputComponent
                                            ...
                                            placeholder="Введите внесенное количество за год в тоннах"
                                        />
                                    )}
                                </div>
                            </FormGroup>
